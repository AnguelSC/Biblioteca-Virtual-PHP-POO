	...
	<div class="col-sm-3">
		<form method="post" action="index.php?menu=usuario_buscar">
			<div class="form-group">
				<label>Por DNI</label>
				<input class="form-control" name="dni" placeholder="Que buscar">	
			</div>
			<div class="form-group">
				<label>Por Nombre</label>
				<input class="form-control" name="nombre" placeholder="Que buscar">
			</div>
			<div class="form-group">
		      	<label for="apellido">Por Apellido:</label>
		      	<input class="form-control" name="apellido" placeholder="Que buscar">
		    </div>
