...
{
	$q = mysql_query("UPDATE libro SET Estado =0");
	if (!$q) {
		mysql_error();
	}
...
?>
 ...
 <div class="alert alert-danger">¿Esta seguro que desea eliminar todos los libros?</div>
 <div class="col-lg-12">
    <div class="radio">
      <label>
 ...
 <a class="btn btn-success" href="index.php?menu=obras_borrartodo&opcion=si">Eliminar TODO</a> <a href="index.php" class="btn btn-default">Cancelar</a>
