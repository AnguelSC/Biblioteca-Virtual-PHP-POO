...
<div class="box box-danger">
  <div class="box-header"><h3 class="box-title">agregar obra</h3></div>
  <div class="box-body">
        ...
        <div class="form-group form-group-sm">
          ...
          <div class="col-lg-10">
            <select multiple="multiple" name="autores[]" id="listaAutores" class="form-control chosen" placeholder="Seleccione autores">
              ...
              <a class="btn btn-success btn-xs" data-toggle="modal" data-target="#agregaautor">Añadir Autor</a>
          </div>
        ...
        <div class="form-group form-group-sm">
          ...
          <div class="col-lg-10">
            ...
            ?>
              ...
              <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#agregaeditorial">Añadir Editorial</a>
                    ...
                    <div class="modal-body">
                      <div class="form-group form-group-sm">
                        <label>Nombre de la Editorial</label>
                          <input type="text" class="from-control" name="editorialAgrega" id="editorialAgrega"/>
                      </div>
                      <div id="estado_editorial"></div>
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                      <button type="button" class="btn btn-primary"  id="botonAgregareditorial">Agregar editorial</button>
                    </div>
                  </div>
                </div>
              </div>
